...
from data.office_dataset import Office_FedDG
...
def get_argparse():
    ...
    parser.add_argument("--dataset", type=str, default='office', choices=['office'], help='Name of dataset')
    parser.add_argument("--model", type=str, default='resnet18',
                        choices=['resnet18', 'resnet50'], help='model name')
    parser.add_argument("--test_domain", type=str, default='office_a',
                        choices=['office_a', 'office_c', 'office_p', 'office_r'], help='the domain name for testing')
    parser.add_argument('--num_classes', help='number of classes default 5', type=int, default=65)
...
def main():
    ...
    dataobj = Office_FedDG(test_domain=args.test_domain, batch_size=args.batch_size)
