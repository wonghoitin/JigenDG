...
from data.dr_dataset import DR_FedDG
...
def get_argparse():
    ...
    parser.add_argument("--dataset", type=str, default='dr', choices=['dr'], help='Name of dataset')
    parser.add_argument("--model", type=str, default='resnet18',
                        choices=['resnet18', 'resnet50'], help='model name')
    parser.add_argument("--test_domain", type=str, default='dohc',
                        choices=['oia', 'dohc', 'drtid'], help='the domain name for testing')
...
def main():
    ...
    dataobj = DR_FedDG(test_domain=args.test_domain, batch_size=args.batch_size)
